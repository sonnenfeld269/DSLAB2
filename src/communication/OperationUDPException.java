 ...
 * @author sanker
 */
public class OperationUDPException extends Exception {
    
    public OperationUDPException(){ }
    public OperationUDPException(String s){super(s); }
    /*
     ...
     */
    public OperationUDPException(String s,Throwable cause){super(s,cause); }
