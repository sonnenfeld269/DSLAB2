 ...
 * @author sanker
 */
public class ServerUDPException extends Exception {
    
    public ServerUDPException(){ }
    public ServerUDPException(String s){super(s); }
    /*
     ...
     */
    public ServerUDPException(String s,Throwable cause){super(s,cause); }
