 ...
 * @author sanker
 */
public class ClientUDPException extends Exception {
    
    public ClientUDPException(){ }
    public ClientUDPException(String s){super(s); }
    /*
     ...
     */
    public ClientUDPException(String s,Throwable cause){super(s,cause); }
