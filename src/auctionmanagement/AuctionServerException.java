...
public class AuctionServerException extends Exception {
    
    public AuctionServerException(){ }
    public AuctionServerException(String s){super(s); }
    /*
     ...
     */
    public AuctionServerException(String s,Throwable cause){super(s,cause); }
